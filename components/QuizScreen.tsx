    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[50vh] animate-fade-in text-center p-6 space-y-8">
         ...
         <div>
            ...
            <p className="text-green-100 text-2xl font-bold leading-relaxed">{question.info}</p>
         </div>
      </div>
    );
  }
    ...
    <div className="w-full max-w-md mx-auto animate-fade-in">
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center space-x-2 text-pandora-cyan/70">
           ...
           <span className="font-display text-sm tracking-widest uppercase">Question System</span>
        </div>
      ...
      {/* Progress Bar HUD */}
      <div className="mb-10 relative h-2 w-full bg-white/10 rounded-full overflow-hidden">
        <div 
      ...
      <div className="glass-panel p-8 rounded-3xl mb-8 border-l-4 border-l-pandora-cyan relative">
        {/* Increased question text size significantly */}
      ...
      {/* Error Message */}
      {errorMsg && (
        <div className="bg-red-500/10 border border-red-500/30 text-red-200 p-4 rounded-xl mb-8 flex items-center justify-center space-x-3 animate-bounce">
      ...
      <div className="space-y-5">
        {question.options.map((option, idx) => (
          <Button 
            ...
            className={selectedOption === option && !isSuccess ? '!border-red-500/50 !text-red-200' : ''}
          >
            {option}
          </Button>
        ))}
